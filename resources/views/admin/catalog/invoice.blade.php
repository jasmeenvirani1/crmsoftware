...
<head>
    ...
    <style>
        ...
        .shadow {
            box-shadow: 0 3px 12px 1px rgba(43, 55, 72, .15) !important
        }

        .shadow-sm {
            box-shadow: 0 .125rem .25rem rgba(43, 55, 72, .15) !important
        }

        .shadow-lg {
            box-shadow: 0 1rem 3rem rgba(43, 55, 72, .25) !important
        }
        ...
        .card {
            box-shadow: 0px 1px 3px 0px rgba(54, 74, 99, .05)
        }

        .card .card {
            box-shadow: 0px 1px 6px 1px rgba(54, 74, 99, .1)
        }
        ...
        .details-wrapper .invoice,
        .details-wrapper .order {
            margin-top: 1rem;
        }
        ...
        <div class="nk-main ">
            <div class="container-fluid">
                <div class="nk-content-body">
                    ...
                    <div class="nk-block">
                        <div class="invoice">
                            <div class="invoice-wrap p-0">
                                {{-- Header --}}
                                <header>
                                    {{-- Top nav --}}
                                    <div class="disclaimer">
                                        <ul>
                                            <li>Original for recepient</li>
                                        </ul>
                                    </div>
                                    <hr>
                                    <div class="details">
                                        <h1 class="heading">BLANCORA BY SNEH NANDU</h1>
                                        <p class="address">32, GIDNEY PARK, ONELLA , PUNE : 37</p>
                                        <p class="state">STATE NAME : MAHARASHTRA / STATE CODE: <b>MH</b></p>
                                        <p class="gst">GST NO: <b>27CPDPS8074L2Z3</b></p>
                                        <p class="pan">PAN No. <b>CPDPS8074L</b></p>
                                    </div>
                                    <hr>
                                    <div>
                                        <h2 class="heading heading2">* TAX INVOICE *</h2>
                                    </div>
                                </header>
                                ...
                                <main>
                                    {{-- Details --}}
                                    <div class="details-wrapper my-4">
                                        <div class="details">
                                            <h3 class="heading heading3">To, Jasmeen Virani</h3>
                                            <p>
                                                {{-- Shipping address --}}
                                                Test ,
                                                Rajkot ,
                                        ...
                                        <div class="invoice">
                                            <p>Invoice No: <b> 57869 </b></p>
                                            <p>Invoice Generated at:
                                                <b>{{ \Carbon\Carbon::parse()->format('d M, Y g:i A') }}</b>
                                            </p>
                                            <p>Mobile No: <b>8128485820</b></p>
                                        </div>
                                        <div class="order">
                                            <p>Order No: <b>81284</b></p>
                                            <p>Date of Order:
                                                <b>31-05-2023</b>
                                            </p>
                                        </div>
                                        ...
                                        <table class="table table-striped w-100">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="w-5">Qty</th>
                                                    <th class="w-5">Net Amount</th>
                                                    <th class="w-10">Tax</th>
                                                    <th class="w-10">Tax Amount</th>
                                                    <th class="w-10">Total (Incl.Tax)</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @php
                                ...
                                <footer>
                                    ...
                                    <div class="disclaimer">
                                        <ul>
                                            <li>Invoice was created on a computer and is valid without the signature and
                                                seal.</li>
                                        </ul>
                                    </div>
                                </footer>
