                            ...
                            <div class="kt-portlet__body">
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4 col-xl-4">  
                                                <input type="text"  name="quotation_no[]" value="{{$data->quotation_no['0']}}" id="quotation_no" class="form-control" placeholder="Quotation_No" readonly> 
                                            </div>
                                            <div class="col-lg-5 col-xl-2">
                                                <select class="form-control selectpicker" id="revision" name="quotation_no[]" data-live-search="true">
                                                <option value="R0" {{ $data->quotation_no['1'] == 'R0' ? 'selected' : '' }}>R0</option>
                                                <option value="R1" {{ $data->quotation_no['1'] == 'R1' ? 'selected' : '' }}>R1</option>
                                                <option value="R2" {{ $data->quotation_no['1'] == 'R2' ? 'selected' : '' }}>R2</option>
                                                <option value="R3" {{ $data->quotation_no['1'] == 'R3' ? 'selected' : '' }}>R3</option>
                                                <option value="R4" {{ $data->quotation_no['1'] == 'R4' ? 'selected' : '' }}>R4</option>
                                                <option value="R5" {{ $data->quotation_no['1'] == 'R5' ? 'selected' : '' }}>R5</option>
                                                <option value="R6" {{ $data->quotation_no['1'] == 'R6' ? 'selected' : '' }}>R6</option>
                                                <option value="R7" {{ $data->quotation_no['1'] == 'R7' ? 'selected' : '' }}>R7</option>
                                                <option value="R8" {{ $data->quotation_no['1'] == 'R8' ? 'selected' : '' }}>R8</option>
                                                <option value="R9" {{ $data->quotation_no['1'] == 'R9' ? 'selected' : '' }}>R9</option>
                                                <option value="R10" {{ $data->quotation_no['1'] == 'R10' ? 'selected' : '' }}>R10</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row" id="add_button">
                                            ...
                                            <div class="col-lg-4 col-xl-4">  
                                                <select class="form-control selectpicker" id="customer_name" name="customer_name[]" data-live-search="true">
                                                    ...
                                                    <option value="{{$customers->id}}" {{ $data->customer_name == $customers->id ? 'selected' : '' }}>{{$customers->name}}</option>
                                                    @endforeach
                                                </select></div>
                                    ...
                                    <!-- <div class="form-group row">
                                        ...
                                        <input type="text" name="follow_up" value="{{$data->follow_up}}" id="kt_datepicker_1" class="form-control" >  
                                        </div>
                                    </div> -->
                                    <div class="form-group row">
                                    ...
                                    <!-- <div class="form-group row">
                                        ...
                                        <table border="2"><tr><td><table class="table table-striped" id="d_{{$a}}{{$a}}" border="2"><tr><th colspan="6">Description</th><th>HSN Code/SAC Code</th><th>Unit Price(INR)</th><th>Qty.</th><th>Total Price(INR)</th></tr><tr><th colspan="1">Product</th><td colspan="5"><select class="form-control selectpicker" id="product_name" name="product_name{{$a}}{{$a}}" data-live-search="true" required><option value="">---SELECT---</option>@foreach($product as $products)<option value="{{$products->product_name}}" {{ $demo1->product_name == $products->product_name ? 'selected' : '' }}>{{$products->product_name}}</option>@endforeach</select></td><td rowspan="3" colspan="4" id="add_field"><center><button id="add_field1_{{$a}}{{$a}}" onclick="i_d({{$a}});" class="btn btn-brand btn-icon-sm" aria-expanded="false"><i class="flaticon2-plus"></i>Add Dimension</button></center></td></tr><tr><th colspan="3">Internal Dimension</th><th colspan="3">External Dimension</th></tr><tr><th>Width</th><th>Depth</th><th>Height</th><th>Width</th><th>Depth</th><th>Height</th></tr><?php $count = count($demo1->i_d_height); 
                                        $i=0;?>@for($j=0; $j<$count; $j++)<tr><td><input type="number" name="i_d_width{{$a}}{{$a}}[]" id="width" class="form-control" placeholder="Width" value="{{$demo1->i_d_width[$i]}}" required></td><td><input type="number" name="i_d_depth{{$a}}{{$a}}[]" id="depth" class="form-control" placeholder="Depth" value="{{$demo1->i_d_depth[$i]}}" required></td><td><input type="number" name="i_d_height{{$a}}{{$a}}[]" id="height" class="form-control" placeholder="Height" value="{{$demo1->i_d_height[$i]}}" required></td><td><input type="number" name="e_d_width{{$a}}{{$a}}[]" id="width" class="form-control" placeholder="Width" value="{{$demo1->e_d_width[$i]}}" required></td><td><input type="number" name="e_d_depth{{$a}}{{$a}}[]" id="depth" class="form-control" value="{{$demo1->e_d_depth[$i]}}" placeholder="Depth" required></td><td><input type="number" name="e_d_height{{$a}}{{$a}}[]" id="height" class="form-control" placeholder="Height" value="{{$demo1->e_d_height[$i]}}" required></td><td><input type="number" name="h_s_code{{$a}}{{$a}}[]" id="h_s_code" class="form-control" value="{{$demo1->h_s_code[$i]}}" placeholder="HSN/SAC Code" required></td><td><input type="number" name="unit_price{{$a}}{{$a}}[]" id="unit_price_{{$a}}{{$a}}_{{$a}}{{$a}}" oninput="getamount({{$a}}{{$a}});" class="form-control" value="{{$demo1->unit_price[$i]}}" placeholder="Unit Price" required></td><td><input type="number" name="quantity{{$a}}{{$a}}[]" id="quantity_{{$a}}{{$a}}_{{$a}}{{$a}}" oninput="getamount({{$a}}{{$a}});" class="form-control" value="{{$demo1->quantity[$i]}}" placeholder="Qty." required></td><td><input type="number" name="total_price{{$a}}{{$a}}[]" id="total_price_{{$a}}{{$a}}_{{$a}}{{$a}}" class="form-control" placeholder="Total Price" value="{{$demo1->total_price[$i]}}" readonly></td></tr><?php $i++;?>@endfor</table><input type="hidden" name="itemCount1[]"  id="itemCount1" value="{{$a}}{{$a}}"></td></tr><tr><td><div class="col-xl-12 col-lg-12 form-group row"><label class="col-xl-3 col-lg-3 col-form-label" style="font-size: 15px;"><b>Select Technical Specification</b></label><div class="col-lg-4 col-xl-4"><select class="form-control selectpicker" id="tech_specification_{{$a}}{{$a}}" name="tech_specification{{$a}}{{$a}}" onchange="getdata2({{$a}});" data-live-search="true" required><option value="">---SELECT---</option>@foreach($tech as $tech1)<option value="{{$tech1->product_name}}" {{ $demo1['tech_specification']->product_name == $tech1->product_name ? 'selected' : '' }}>{{$tech1->product_name}}</option>@endforeach</select></div><div class="col-lg-5 col-xl-3"><center><button onclick="i_d1({{$a}});" class="btn btn-brand btn-icon-sm" aria-expanded="false"><i class="flaticon2-plus"></i>Add TechnicalSpecification</button></center></div></div><div class="col-xl-12 col-lg-12 form-group row tech_specification" id="tech_spec_{{$a}}{{$a}}"><?php $data = count($demo1['tech_specification']->title);$i=0;?>@for($j=0; $j<$data; $j++)<table class="col-xl-12 col-lg-12 table table-striped" border="2"><tr><th><label class="col-form-label"><b>Title</b></label></th><td><input type="text" name="title{{$a}}{{$a}}[]" class="form-control" value="{{$demo1['tech_specification']->title[$i]}}"  required></td></tr><tr><th><label class="col-form-label"><b>Description</b></label></th><td><textarea class="form-control" name="details{{$a}}{{$a}}[]" required>{{$demo1['tech_specification']->details[$i]}}</textarea></td></tr></table><?php $i++;?>@endfor</div></td></tr><tr><td><div class="col-xl-12 col-lg-12 form-group row"><label class="col-xl-3 col-lg-3 col-form-label" style="font-size: 15px;"><b>Select Terms</b></label><div class="col-lg-4 col-xl-4"><select class="form-control selectpicker" id="terms_{{$a}}{{$a}}" name="terms{{$a}}{{$a}}" onchange="getdata3({{$a}});" data-live-search="true"  required><option value="">---SELECT---</option>@foreach($terms as $term)<option value="{{$term->title}}" {{ $data2[$a]['terms']->title[0] == $term->title ? 'selected' : '' }}>{{$term->title}}</option>@endforeach</select></div><div class="col-lg-5 col-xl-3"><center><button onclick="i_d2({{$a}});" class="btn btn-brand btn-icon-sm" aria-expanded="false"><i class="flaticon2-plus"></i>Add Terms</button></center></div></div><div class="col-xl-12 col-lg-12 form-group row terms" id="term1_{{$a}}{{$a}}"><?php $term=count($data2[$a]['terms']->title);$i=0;?>@for($j=0; $j<$term; $j++)<table class="col-xl-12 col-lg-12 table table-striped" border="2"><tr><th><label class="col-form-label"><b>Title</b></label></th><td><input type="text" name="title1{{$a}}{{$a}}[]" value="{{$data2[$a]['terms']->title[$i]}}" class="form-control"  required></td></tr><tr><th><label class="col-form-label"><b>Description</b></label></th><td><textarea class="form-control" name="description{{$a}}{{$a}}[]" required>{{$data2[$a]['terms']->description[$i]}}</textarea></td></tr></table><?php $i++;?>@endfor</div></tr></table><div class="form-group row"></div><?php $a++;?>@endforeach
                                    </div>
                                </div>
                            </div>
...
function i_d($a){
    // alert($a);
    var wrapper = $("#d_"+$a+$a);
        $(wrapper).append('<tr><td><input type="number" name="i_d_width'+$a+$a+'[]" id="width" class="form-control" placeholder="Width" required></td><td><input type="number" name="i_d_depth'+$a+$a+'[]" id="depth" class="form-control" placeholder="Depth" required></td><td><input type="number" name="i_d_height'+$a+$a+'[]" id="height" class="form-control" placeholder="Height" required></td><td><input type="number" name="e_d_width'+$a+$a+'[]" id="width" class="form-control" placeholder="Width" required></td><td><input type="number" name="e_d_depth'+$a+$a+'[]" id="depth" class="form-control" placeholder="Depth" required></td><td><input type="number" name="e_d_height'+$a+$a+'[]" id="height" class="form-control" placeholder="Height" required></td><td><input type="number" name="h_s_code'+$a+$a+'[]" id="h_s_code" class="form-control" placeholder="HSN/SAC Code" required></td><td><input type="number" name="unit_price'+$a+$a+'[]" id="unit_price_'+itemCount+'" oninput="getamountadd('+itemCount+');" class="form-control" placeholder="Unit Price" required></td><td><input type="number" name="quantity'+$a+$a+'[]" id="quantity_'+itemCount+'" oninput="getamountadd('+itemCount+');" class="form-control" placeholder="Qty." required></td><td><input type="number" name="total_price'+$a+$a+'[]" id="total_price_'+itemCount+'" class="form-control" placeholder="Total Price" readonly></td></tr>');
        itemCount++;
    };
function i_d1($a){
    $("#tech_spec_"+$a+$a).append('<table class="col-xl-12 col-lg-12 table table-striped" border="2"><tr><th><label class="col-form-label"><b>Title</b></label></th><td><input type="text" name="title'+$a+$a+'[]" class="form-control"  required></td></tr><tr><th><label class="col-form-label"><b>Description</b></label></th><td><textarea class="form-control" name="details'+$a+$a+'[]" required></textarea></td></tr></table>');
};
function i_d2($a){
    $("#term1_"+$a+$a).append('<table class="col-xl-12 col-lg-12 table table-striped" border="2"><tr><th><label class="col-form-label"><b>Title</b></label></th><td><input type="text" name="title1'+$a+$a+'[]" class="form-control"  required></td></tr><tr><th><label class="col-form-label"><b>Description</b></label></th><td><textarea class="form-control" name="description'+$a+$a+'[]" required></textarea></td></tr></table>');
};   
function getdata3($a){
            var term = $("#terms_"+$a+$a).val();
                            $("#term1_"+$a+$a).html('');
                $.ajax({
                            url:"{{url('getterms')}}",
                            type: "POST",
                            ...
                            $.each(result.terms,function(key,value){
                                ...
                                // $i =0;
                                // for($j=0; $j<data1; $j++){
                            $("#term1_"+$a+$a).append('<table class="col-xl-12 col-lg-12 table table-striped" border="2"><tr><th><label class="col-form-label"><b>Title</b></label></th><td><input type="text" name="title1'+$a+$a+'[]" value='+value.title+' class="form-control"  required></td></tr><tr><th><label class="col-form-label"><b>Description</b></label></th><td><textarea class="form-control" name="description'+$a+$a+'[]" required>'+value.description+'</textarea></td></tr></table>');
                             // $i++;
                        // }
                        }); 
                            }
...
function getdata2($a){
    alert($a);
            var tech_specification = $("#tech_specification_"+$a+$a).val();
                            $("#tech_spec_"+$a+$a).html('');
                $.ajax({
                            ...
                            $.each(result.tech_specification,function(key,value){
                                ...
                                $i =0;
                                for($j=0; $j<data; $j++){
                            $("#tech_spec_"+$a+$a).append('<table class="col-xl-12 col-lg-12 table table-striped" border="2"><tr><th><label class="col-form-label"><b>Title</b></label></th><td><input type="text" name="title'+$a+$a+'[]" value='+value.title[$i]+' class="form-control"  required></td></tr><tr><th><label class="col-form-label"><b>Description</b></label></th><td><textarea class="form-control" name="details'+$a+$a+'[]" required>'+value.details[$i]+'</textarea></td></tr></table>');
                            $i++;
                        }
                        }); 
                        }
