        ...
        <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__head kt-portlet__head--lg">
                ...
                <div class="kt-portlet__head-toolbar">
                    ...
                    <!-- <div class="kt-portlet__head-wrapper">                
                        <div class="dropdown dropdown-inline">
                            <a href="{{route('notification')}}" class="btn btn-brand btn-icon-sm" aria-expanded="false">
...
@endsection
@section('script')
<script src="{{url('assets/admin/js/pages/quotation.js')}}" type="text/javascript"></script>
@endsection