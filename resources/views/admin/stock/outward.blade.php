                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="kt-portlet">
                            ...
                            <form action="{{ route('outward.store') }}" method="POST" id="create_category"
                                        ...
                                        <div class="kt-section__body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-4">
                                                    <input type="number" step="1" name="outward_qty" id="outward_qty"
                                                        class="form-control" placeholder="Outward Qty.">
                                                </div>
                                            </div>
