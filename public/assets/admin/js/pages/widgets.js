    ...
    var _initDaterangepicker = function () {
        ...
        function cb(start, end, label) {
            ...
            if ((end - start) < 100 || label == 'Today') {
                ...
                title = 'Tomorrow:';
                range = start.format('MMM D');
            } else if (label == 'After 5 Days') {
                title = 'After 5 Days:';
                range = start.format('MMM D');
            }else if (label == 'After 15 Days') {
                title = 'After 15 Days:';
                range = start.format('MMM D');
            }else if (label == 'After 30 Days') {
                title = 'After 30 Days:';
                range = start.format('MMM D');
            } else {
        ...
        picker.daterangepicker({
            ...
            ranges: {
                ...
                'After 5 Days': [moment().add(5, 'days'), moment().add(5, 'days')],
                'After 15 Days': [moment().add(15, 'days'), moment().add(15, 'days')],
                'After 30 Days': [moment().add(30, 'days'), moment().add(30, 'days')]
            }
        }, cb);
