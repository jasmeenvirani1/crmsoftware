                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row" id="add_button">
                                            ...
                                            <div class="col-lg-4 col-xl-4">  
                                                <input type="email" name="email[]" value="{{old('email',isset($data->email)?$data->email:'')}}" id="email" class="form-control" placeholder="Email Id" required>
                                            </div> 
...
$(document).ready(function(){
    ...
    $(add_button).click(function(e){
        e.preventDefault();
        $(wrapper).append('<div class="col-lg-3 col-xl-3"></div><div class="col-lg-4 col-xl-4"><input type="email" name="email[]" value="{{old('email',isset($data->email)?$data->email:'')}}" id="email" class="form-control" placeholder="Email Id" required></div>');
        });
});
</script>
<script type="text/javascript">
