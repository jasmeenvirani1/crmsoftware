                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-4">  
                                                <select class="form-control" id="vendor_company_country" name="vendor_company_country">
                                                    ...
                                                    <option value="{{$countries->id}}" @if($data->vendor_company_country == $countries->id) selected="selected" @endif  >{{$countries->name}}</option>
                                                    @endforeach
                                                </select> 
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-4">  
                                                <select class="form-control" id="vendor_company_state" name="vendor_company_state">
                                                    ...
                                                    <option value="{{$states->id}}" @if($data->vendor_company_state == $states->id) selected="selected" @endif  >{{$states->name}}</option>
                                                    @endforeach
                                                </select> 
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-4">  
                                                <select class="form-control" id="vendor_company_city" name="vendor_company_city">
                                                    ...
                                                    <option value="{{$cities->id}}" @if($data->vendor_company_city == $cities->id) selected="selected" @endif  >{{$cities->name}}</option>
                                                    @endforeach
                                                </select> 
                                            </div>
                                        </div>
...
$(document).ready(function() {
        $('#vendor_company_country').on('change', function() {
                ...
                $.ajax({
                            ...
                            $("#vendor_company_state").append('<option value="'+value.id+'" @if($data->vendor_company_state == '+value.id+')  selected="selected"  @endif>'+value.name+'</option>');
                        });
                 ...
                 $('#vendor_company_state').on('change', function() {
                        ...
                        $.ajax({
                                    ...
                                    $("#vendor_company_city").append('<option value="'+value.id+'" @if($data->vendor_company_city == '+value.id+')  selected="selected"  @endif>'+value.name+'</option>');
                                    });
                                }
                            });
                        });
