                ...
                <div class="col-xl-12">
                    ...
                    <div class="kt-portlet">
                        ...
                        <form action="{{ route('role.store') }}" method="POST" id="create_category" name="create_category"  class="form-horizontal kt-form kt-form--label-right" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="id1"  id="id1" value="{{$data->id}}">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-2 col-xl-2">  
                                                <span class="switch switch-info">
                                                    <label>
                                                        <input type="checkbox" name="organization" <?php if($data->organization == '1') echo "checked";?>/>
                                                        <span></span>
                                                    </label>
                                            ...
                                            <div class="col-lg-2 col-xl-2">  
                                                <span class="switch switch-info">
                                                    <label>
                                                        <input type="checkbox" name="user_role" <?php if($data->user_role == '1') echo "checked";?>/>
                                                        <span></span>
                                                    </label>
                                            ...
                                            <div class="col-lg-2 col-xl-2">  
                                                <span class="switch switch-info">
                                                    <label>
                                                        <input type="checkbox" name="sales" <?php if($data->sales == '1') echo "checked";?>/>
                                                        <span></span>
                                                    </label>
                                            ...
                                            <div class="col-lg-2 col-xl-2">  
                                                <span class="switch switch-info">
                                                    <label>
                                                        <input type="checkbox" name="inventory_management" <?php if($data->inventory_management == '1') echo "checked";?>/>
                                                        <span></span>
                                                    </label>
                                            ...
                                            <div class="col-lg-2 col-xl-2">  
                                                <span class="switch switch-info">
                                                    <label>
                                                        <input type="checkbox" name="purchase" <?php if($data->purchase == '1') echo "checked";?>/>
                                                        <span></span>
                                                    </label>
                                            ...
                                            <div class="col-lg-2 col-xl-2">  
                                                <span class="switch switch-info">
                                                    <label>
                                                        <input type="checkbox" name="customer" <?php if($data->customer == '1') echo "checked";?>/>
                                                        <span></span>
                                                    </label>
                                            ...
                                            <div class="col-lg-2 col-xl-2">  
                                                <span class="switch switch-info">
                                                    <label>
                                                        <input type="checkbox" name="technical_specification" <?php if($data->technical_specification == '1') echo "checked";?>/>
                                                        <span></span>
                                                    </label>
                                            ...
                                            <div class="col-lg-2 col-xl-2">  
                                                <span class="switch switch-info">
                                                    <label>
                                                        <input type="checkbox" name="terms" <?php if($data->terms == '1') echo "checked";?>/>
                                                        <span></span>
                                                    </label>
                                            ...
                                            <div class="col-lg-2 col-xl-2">  
                                                <span class="switch switch-info">
                                                    <label>
                                                        <input type="checkbox" name="notification" <?php if($data->notification == '1') echo "checked";?>/>
                                                        <span></span>
                                                    </label>
                                            ...
                                            <div class="col-lg-2 col-xl-2">  
                                                <span class="switch switch-info">
                                                    <label>
                                                        <input type="checkbox" name="setting" <?php if($data->setting == '1') echo "checked";?>/>
                                                        <span></span>
                                                    </label>
